...
\@y{%
 \ensuremath{ReadOps(h) \.{\defeq} \.{\,\backslash\,}}* Return the set of all
 read operations in history \ensuremath{h \.{\in} History}.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\{op \.{\in} Ops(h) \.{:} op.type \.{=} \mbox{''}read\mbox{``}\}
}}%
\@xx{}%
...
\@y{%
 \ensuremath{WriteOps(h) \.{\defeq} \.{\,\backslash\,}}* Return the set of
 all write operations in history \ensuremath{h \.{\in} History}.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\{op \.{\in} Ops(h) \.{:} op.type \.{=} \mbox{''}write\mbox{``}\}
}}%
\@xx{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} WellFormed ( h ) \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}}%
\@y{\@s{2.5}%
 \ensuremath{\.{\land} h \.{\in} History
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\land}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} ProgramOrder ( h )
 \.{\defeq} {\UNION} \{ Seq2Rel ( s ) \.{:} s \.{\in} h \}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} POPast ( h ,\, o )
 \.{\defeq} InverseImage ( ProgramOrder ( h ) ,\, o )}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} CausalPast ( co ,\, o )
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} CausalHist ( co ,\, o )
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} CausalArb ( co ,\, arb ,\, o
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} RWRegSemantics ( seq ,\, o )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} {\IF} o . type
 \.{=}\@w{write} \.{\THEN} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\ELSE} \.{\LET}
 wseq \.{\defeq} SelectSeq ( seq ,\, {\LAMBDA} op \.{:} op . type
 \.{=}\@w{write} \.{\land} op . key \.{=} o . key )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{47.71} \.{\IN} {\IF} wseq
 \.{=} {\langle} {\rangle} \.{\THEN} o . val \.{=} InitVal}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{68.11} \.{\ELSE} o . val
 \.{=} wseq [ Len ( wseq ) ] . val}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} AxCausalValue ( co ,\, o )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} \.{\LET} seqs
 \.{\defeq} AllLinearExtensions ( CausalHist ( co ,\, o ) ,\, CausalPast ( co
 ,\, o ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{16.4} \.{\IN} {\TRUE}
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} AxCausalArb ( co ,\, arb ,\,
 o ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} \.{\LET} seq
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \.{\IN}
 RWRegSemantics ( seq ,\, o )}%
\@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} CC ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CC}
 (Causal Consistency)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{25.53} \.{\LET} ops
 \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{25.53} \.{\IN} \E\, co
 \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
\@y{\@s{0}%
 \ensuremath{TODO}: to generate (given a chain decomposition)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{57.25} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )\@s{65.6}}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{57.25} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{57.25} \.{\land} PrintT
 (\@w{co:\ } \.{\circ} ToString ( co ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{57.25} \.{\land} \A\, o
 \.{\in} ops \.{:} AxCausalValue ( co ,\, o )\@s{53.32}}%
\@y{\@s{0}%
 \ensuremath{AxCausalValue
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}} CCv ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{23.87} \.{\LET} ops
 \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{23.87} \.{\IN} \E\, co
 \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
\@y{\@s{0}%
 \ensuremath{TODO}: to generate (given a chain decomposition)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{55.59} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )\@s{67.25}}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{55.59} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{55.59} \.{\land} PrintT
 (\@w{co:\ } \.{\circ} ToString ( co ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{55.59} \.{\land} \E\,
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{78.03} \.{\land} \A\, o
 \.{\in} ops \.{:} AxCausalArb ( co ,\, arb ,\, o )\@s{1.11}}%
\@y{\@s{0}%
 \ensuremath{AxCausalArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{78.03} \.{\land} PrintT
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}} CCv2 ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{24.98} \.{\LET} ops
 \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{24.98} \.{\IN} \E\, co
 \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
\@y{\@s{0}%
 \ensuremath{FIXME}: efficiency\.{!!}!
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{56.70} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{56.70} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{56.70} \.{\land} PrintT
 (\@w{co:\ } \.{\circ} ToString ( co ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{56.70} \.{\land} \E\,
 arb \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}\@s{4.1}}%
\@y{\@s{0}%
 to generate; not to test
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{79.14} \.{\land} Respect
 ( arb ,\, co )\@s{86.67}}%
\@y{\@s{0}%
 \ensuremath{AxArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{79.14} \.{\land}
 IsStrictTotalOrder ( arb ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{79.14} \.{\land} \A\, o
 \.{\in} ops \.{:} AxCausalArb ( co ,\, arb ,\, o )}%
\@y{\@s{0}%
 \ensuremath{AxCausalArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{79.14} \.{\land} PrintT
 (\@w{arb:\ } \.{\circ} ToString ( arb ) )}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}} CCv1 ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{24.98} \.{\LET} ops
 \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{24.98} \.{\IN} \E\, co
 \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
\@y{\@s{0}%
 \ensuremath{FIXME}: efficiency\.{!!}!
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{56.70} \.{\land} \E\,
 arb \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{71.92} \.{\land} PrintT
 (\@w{co:\ } \.{\circ} ToString ( co ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{71.92} \.{\land} PrintT
 (\@w{arb:\ } \.{\circ} ToString ( arb ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{71.92} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{71.92} \.{\land}
 IsStrictTotalOrder ( arb ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{71.92} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )\@s{36.89}}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{71.92} \.{\land} Respect
 ( arb ,\, co )\@s{99.05}}%
\@y{\@s{0}%
 \ensuremath{AxArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{71.92} \.{\land} \A\, o
 \.{\in} ops \.{:} AxCausalArb ( co ,\, arb ,\, o )\@s{12.38}}%
\@y{\@s{0}%
 \ensuremath{AxCausalArb
}}%
\@xx{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Apr} 18
 10:31:01 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
