...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{8.2} {\UNION} \{ Range (
 s ) \.{:} s \.{\in} h \}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} WellFormed ( h ) \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}}%
\@y{\@s{2.5}%
 \ensuremath{\.{\land} h \.{\in} History
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{8.2} \.{\land}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} ProgramOrder ( h )
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} POPast ( h ,\, o )
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} CausalPast ( co ,\, o )
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} CausalHist ( co ,\, o )
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} CausalArb ( co ,\, arb ,\, o
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} AxCausalValue ( co ,\, o )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \.{\LET} seqs
 \.{\defeq} AllLinearExtensions ( CausalHist ( co ,\, o ) ,\, CausalPast ( co
 ,\, o ) )}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\IN} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}} AxCausalArb ( co ,\, arb ,\,
 o ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\LET} seq
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{28.69} wseq\@s{1.45}
 \.{\defeq} SelectSeq ( seq ,\, {\LAMBDA} op \.{:} op . type \.{=}\@w{write}
 \.{\land} op . key \.{=} o . key )}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.1}
 {\IF} wseq \.{=} {\langle} {\rangle} \.{\THEN} o . val \.{=} InitVal}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{40.89} \.{\ELSE} o . val
 \.{=} wseq [ Len ( wseq ) ] . val}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} CC ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CC}
 (Causal Consistency)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{25.53} \.{\LET} ops
 \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{25.53} \.{\IN} \E\, co
 \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
\@y{\@s{0}%
 \ensuremath{TODO}: to generate (given a chain decomposition)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{57.25} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )\@s{65.6}}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{57.25} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{57.25} \.{\land} PrintT
 (\@w{co:\ } \.{\circ} ToString ( co ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{57.25} \.{\land} \A\, o
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}} CCv ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{23.87} \.{\LET} ops
 \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{23.87} \.{\IN} \E\, co
 \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
\@y{\@s{0}%
 \ensuremath{TODO}: to generate (given a chain decomposition)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{55.59} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )\@s{67.25}}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{55.59} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{55.59} \.{\land} PrintT
 (\@w{co:\ } \.{\circ} ToString ( co ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{55.59} \.{\land} \E\, arb
 \.{\in} \{ Seq2Rel ( le ) \.{:} le \.{\in} AllLinearExtensions ( co ,\, ops
 ) \} \.{:}}%
\@y{\@s{0}%
 \ensuremath{AxArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{78.03} \.{\land} \A\, o
 \.{\in} ops \.{:} AxCausalArb ( co ,\, arb ,\, o )\@s{1.11}}%
\@y{\@s{0}%
 \ensuremath{AxCausalArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{78.03} \.{\land} PrintT
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}} CCv2 ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{24.98} \.{\LET} ops
 \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{24.98} \.{\IN} \E\, co
 \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
\@y{\@s{0}%
 \ensuremath{FIXME}: efficiency\.{!!}!
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{56.70} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{56.70} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{56.70} \.{\land} PrintT
 (\@w{co:\ } \.{\circ} ToString ( co ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{56.70} \.{\land} \E\,
 arb \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}\@s{4.1}}%
\@y{\@s{0}%
 to generate; not to test
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{79.14} \.{\land} Respect
 ( arb ,\, co )\@s{86.67}}%
\@y{\@s{0}%
 \ensuremath{AxArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{79.14} \.{\land}
 IsStrictTotalOrder ( arb ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{79.14} \.{\land} \A\, o
 \.{\in} ops \.{:} AxCausalArb ( co ,\, arb ,\, o )}%
\@y{\@s{0}%
 \ensuremath{AxCausalArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{79.14} \.{\land} PrintT
 (\@w{arb:\ } \.{\circ} ToString ( arb ) )}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}} CCv1 ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{56.70} \.{\land} \E\,
 arb \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{71.92} \.{\land} PrintT
 (\@w{co:\ } \.{\circ} ToString ( co ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{71.92} \.{\land} PrintT
 (\@w{arb:\ } \.{\circ} ToString ( arb ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{71.92} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{71.92} \.{\land}
 IsStrictTotalOrder ( arb ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{71.92} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )\@s{36.89}}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{71.92} \.{\land} Respect
 ( arb ,\, co )\@s{99.05}}%
\@y{\@s{0}%
 \ensuremath{AxArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{71.92} \.{\land} \A\, o
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Apr} 17
 19:30:51 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
