...
\end{lcom}%
 ...
 Sequences ,\, FiniteSets ,\, Functions ,\, FiniteSetsExt ,\, RelationUtils
 ,\, TLC}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} ProgramOrder ( h )
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} POPast ( h ,\, o )
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} CausalPast ( co ,\, o )
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} CausalArb ( co ,\, arb ,\, o
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} CCv ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{8.2} \.{\land} WellFormed
 ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{8.2} \.{\land} \.{\LET}
 ops \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{19.31} \.{\IN} \.{\land}
 \E\, co \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
\@y{\@s{0}%
 \ensuremath{FIXME}: efficiency\.{!!}!
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{59.02} \E\, arb \.{\in}
 {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{67.22} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{67.22} \.{\land}
 IsStrictTotalOrder ( arb ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{67.22} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{67.22} \.{\land} Respect
 ( arb ,\, co )\@s{62.15}}%
\@y{\@s{0}%
 \ensuremath{AxArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{67.22} \.{\land} \A\, op
 \.{\in} ops \.{:} {\TRUE}\@s{55.17}}%
\@y{\@s{0}%
 \ensuremath{TODO}: \ensuremath{AxCausalArb
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{8.2} \.{\land} {\FALSE}}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 09 12:46:47 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
