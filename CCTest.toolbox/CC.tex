...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}} CyclicCO ( h ) \.{\defeq}
 Cyclic ( PO ( h ) \.{\cup} RF ( h ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 174\hspace{1em}} WriteCOInitRead ( h )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 175\hspace{1em}}\@s{16.4} \E\, k \.{\in}
 KeyOf ( h ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 176\hspace{1em}}\@s{27.72} \E\, r \.{\in}
 ReadOpsOnKey ( h ,\, k ) ,\, w \.{\in} WriteOpsOnKey ( h ,\, k ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 177\hspace{1em}}\@s{39.04} \.{\land}
 {\langle} w ,\, r {\rangle} \.{\in} CO ( h )}%
\@y{\@s{0}%
 \ensuremath{TODO}: for efficiency
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 178\hspace{1em}}\@s{39.04} \.{\land} r . val
 \.{=} InitVal}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 180\hspace{1em}} ThinAirRead ( h )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 181\hspace{1em}}\@s{16.4} \E\, k \.{\in}
 KeyOf ( h ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 182\hspace{1em}}\@s{27.72} \E\, r \.{\in}
 ReadOpsOnKey ( h ,\, k ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 183\hspace{1em}}\@s{39.04} \.{\land} r . val
 \.{\neq} InitVal}%
 \@x{\makebox[0pt][r]{\scriptsize 184\hspace{1em}}\@s{39.04} \.{\land} \A\, w
 \.{\in} WriteOpsOnKey ( h ,\, k ) \.{:} {\langle} w ,\, r {\rangle}
 \.{\notin} RF ( h )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 186\hspace{1em}} WriteCORead ( h )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 187\hspace{1em}}\@s{16.4} \E\, k \.{\in}
 KeyOf ( h ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 188\hspace{1em}}\@s{27.72} \E\, w1 ,\, w2
 \.{\in} WriteOpsOnKey ( h ,\, k ) ,\, r1 \.{\in} ReadOpsOnKey ( h ,\, k )
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 189\hspace{1em}}\@s{39.04} \.{\land}
 {\langle} w1 ,\, w2 {\rangle} \.{\in} CO ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 190\hspace{1em}}\@s{39.04} \.{\land}
 {\langle} w2 ,\, r1 {\rangle}\@s{2.42} \.{\in} CO ( h )}%
\@y{\@s{0}%
 \ensuremath{TODO}: efficiency
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 191\hspace{1em}}\@s{39.04} \.{\land}
 {\langle} w1 ,\, r1 {\rangle}\@s{2.42} \.{\in} RF ( h )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 193\hspace{1em}} CyclicHB ( h ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{TODO}:
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 194\hspace{1em}}\@s{16.4} {\FALSE}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 196\hspace{1em}} CyclicCF ( h )
 \.{\defeq}\@s{0.48}}%
\@y{\@s{0}%
 \ensuremath{TODO}:
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 197\hspace{1em}}\@s{16.4} {\FALSE}}%
\@x{\makebox[0pt][r]{\scriptsize 198\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{Cyclic(CF(h) \.{\cup} CO(h))
}}%
\@xx{}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 202\hspace{1em}} CCAlg ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Checking algorithm for \ensuremath{CC} (Causal Consistency)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 203\hspace{1em}}\@s{16.4} \.{\land} CyclicCO
 ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 204\hspace{1em}}\@s{16.4} \.{\land}
 WriteCOInitRead ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 205\hspace{1em}}\@s{16.4} \.{\land}
 ThinAirRead ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 206\hspace{1em}}\@s{16.4} \.{\land}
 WriteCORead ( h )}%
\@x{\makebox[0pt][r]{\scriptsize 207\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
