...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}} AllLinearExtensions ( R ,\,
 S ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{16.4} \.{\LET}
 {\RECURSIVE} LinearExtensionsUtil ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{40.89}
 LinearExtensionsUtil ( rel ,\, set ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{57.29} {\IF} set \.{=}
 \{ \} \.{\THEN} \{ {\langle} {\rangle} \}}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{57.29} \.{\ELSE}
 \.{\LET} Extend ( m ) \.{\defeq} \{ {\langle} m {\rangle} \.{\circ} l \.{:}}%
\@y{\@s{0}%
 extend recursively by the minimal element \ensuremath{m
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{121.31} l \.{\in}
 LinearExtensionsUtil ( rel \.{\,\backslash\,} LeftRestriction ( R ,\, m )
 ,\, set \.{\,\backslash\,} \{ m \} ) \}}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{88.61} \.{\IN} {\UNION}
 \{ Extend ( m ) \.{:} m \.{\in} Minimal ( rel ,\, set ) \}}%
\@y{\@s{0}%
 for each minimal element
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 LinearExtensionsUtil ( R ,\, S )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}} LinearExtensions ( R ,\, S
 ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}}\@s{16.4} \{ l \.{\in}
 TupleOf ( S ,\, Cardinality ( S ) ) \.{:} Respect ( Seq2Rel ( l ) ,\, R )
 \}}%
\@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 19 19:48:29 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
