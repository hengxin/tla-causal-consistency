...
\@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}} AnyLinearExtension ( R ,\,
 S ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\LET}
 {\RECURSIVE} LinearExtensionUtil ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{36.79}
 LinearExtensionUtil ( rel ,\, set ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{rel}: remaining relation; set: remaining set
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{53.19} {\IF} set \.{=}
 \{ \} \.{\THEN} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{53.19} \.{\ELSE}
 \.{\LET} m \.{\defeq} {\CHOOSE} x \.{\in} Minimal ( rel ,\, set ) \.{:}
 {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{84.51} \.{\IN} {\langle}
 m {\rangle} \.{\circ} LinearExtensionUtil ( rel \.{\,\backslash\,}
 LeftRestriction ( R ,\, m ) ,\, set \.{\,\backslash\,} \{ m \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{16.4} \.{\IN}
 LinearExtensionUtil ( R ,\, S )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
See https:\ensuremath{\.{\slsl}groups.google.com}/g/tlaplus/\ensuremath{c}/\ensuremath{mtyEmqhlRVg
}%
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}} AllLinearExtensions ( R ,\,
 S ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{16.4} \.{\LET}
 {\RECURSIVE} LinearExtensionsUtil ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{40.89}
 LinearExtensionsUtil ( rel ,\, set ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{57.29} {\IF} set \.{=}
 \{ \} \.{\THEN} \{ {\langle} {\rangle} \}}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{57.29} \.{\ELSE}
 \.{\LET} Extend ( m ) \.{\defeq} \{ {\langle} m {\rangle} \.{\circ} l \.{:}}%
\@y{\@s{0}%
 extend recursively by the minimal element \ensuremath{m
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{121.31} l \.{\in}
 LinearExtensionsUtil ( rel \.{\,\backslash\,} LeftRestriction ( R ,\, m )
 ,\, set \.{\,\backslash\,} \{ m \} ) \}}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{88.61} \.{\IN} {\UNION}
 \{ Extend ( m ) \.{:} m \.{\in} Minimal ( rel ,\, set ) \}}%
\@y{\@s{0}%
 for each minimal element
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 LinearExtensionsUtil ( R ,\, S )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}} LinearExtensions ( R ,\, S
 ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{16.4} \{ l \.{\in}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}} set1 \.{\defeq} \{ 2 ,\, 3
 ,\, 5 ,\, 7 ,\, 8 ,\, 9 ,\, 10 ,\, 11 \}}%
\@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}} rel1\@s{1.06} \.{\defeq}}%
\@y{\@s{0}%
 from https:\ensuremath{\.{\slsl}en.wikipedia.org}/wiki/\ensuremath{Topological\_sorting
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{16.4} \{ {\langle} 3 ,\,
 8 {\rangle} ,\, {\langle} 3 ,\, 10 {\rangle} ,\, {\langle} 5 ,\, 11
 {\rangle} ,\, {\langle} 7 ,\, 8 {\rangle} ,\, {\langle} 7 ,\, 11 {\rangle}
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{21.40} {\langle} 8 ,\, 9
 {\rangle} ,\, {\langle} 11 ,\, 2 {\rangle} ,\, {\langle} 11 ,\, 9 {\rangle}
 ,\, {\langle} 11 ,\, 10 {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}} set2 \.{\defeq} 0
 \.{\dotdot} 5}%
\@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}} rel2\@s{1.06} \.{\defeq}}%
\@y{\@s{0}%
 from https:\ensuremath{\.{\slsl}www.geeksforgeeks.org}/topological-sorting/
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{16.4} \{ {\langle} 2 ,\,
 3 {\rangle} ,\, {\langle} 3 ,\, 1 {\rangle} ,\, {\langle} 4 ,\, 0 {\rangle}
 ,\, {\langle} 4 ,\, 1 {\rangle} ,\, {\langle} 5 ,\, 0 {\rangle} ,\,
 {\langle} 5 ,\, 2 {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}} set3 \.{\defeq} 1
 \.{\dotdot} 6}%
\@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}} rel3\@s{1.06} \.{\defeq}}%
\@y{\@s{0}%
 from https:\ensuremath{\.{\slsl}leetcode.com}/discuss/general-discussion/1078072/introduction-to-topological-sort
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{16.4} \{ {\langle} 1 ,\,
...
\@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}} {\THEOREM} LE \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{16.4} \.{\land}
...
\@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 10:50:36 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
