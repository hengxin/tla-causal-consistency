...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} hasa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) ,\, R (\@w{x} ,\, 2 ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} hasb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 3 ) ,\, R (\@w{x} ,\, 1 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} ha \.{\defeq} \{ hasa ,\,
 hasb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} hbsa \.{\defeq} {\langle} W
 (\@w{z} ,\, 1 ,\, 1 ) ,\, W (\@w{x} ,\, 1 ,\, 2 ) ,\, W (\@w{y} ,\, 1 ,\, 3
 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} hbsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 4 ) ,\, R (\@w{z} ,\, 0 ,\, 5 ) ,\, R (\@w{y}
 ,\, 1 ,\, 6 ) ,\, R (\@w{x} ,\, 2 ,\, 7 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} hb \.{\defeq} \{ hbsa ,\,
 hbsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} hcsa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} hcsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 2 ) ,\, R (\@w{x} ,\, 1 ,\, 3 ) ,\, R (\@w{x}
 ,\, 2 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} hc \.{\defeq} \{ hcsa ,\,
 hcsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} hdsa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) ,\, R (\@w{y} ,\, 0 ,\, 2 ) ,\, W (\@w{y} ,\, 1 ,\, 3
 ) ,\, R (\@w{x} ,\, 1 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} hdsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 5 ) ,\, R (\@w{y} ,\, 0 ,\, 6 ) ,\, W (\@w{y}
 ,\, 2 ,\, 7 ) ,\, R (\@w{x} ,\, 2 ,\, 8 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} hd \.{\defeq} \{ hdsa ,\,
 hdsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} hesa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) ,\, W (\@w{y} ,\, 1 ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} hesb\@s{0.64} \.{\defeq}
 {\langle} R (\@w{y} ,\, 1 ,\, 3 ) ,\, W (\@w{x} ,\, 2 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} hesc\@s{0.71} \.{\defeq}
 {\langle} R (\@w{x} ,\, 2 ,\, 5 ) ,\, R (\@w{x} ,\, 1 ,\, 6 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} he \.{\defeq} \{ hesa ,\,
 hesb ,\, hesc \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} all \.{\defeq} \{ ha ,\, hb
 ,\, hc ,\, hd ,\, he \}}%
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} {\THEOREM} WellFormedTheorem
 \.{\defeq}}%
\@y{\@s{0}%
 test of well-formedness of histories
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \A\, h \.{\in} all
 \.{:} WellFormed ( h )}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} CardOfProgramOrderOfHistory
 ( h ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\LET}
 CardOfProgramOrderOfSession ( s ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{40.89} {\IF} Len ( s )
 ...
 x ,\, h ,\, 0 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} {\THEOREM}
 ProgramOrderCardinalityTheorem \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \A\, h \.{\in} \{
 ha ,\, hb ,\, hc ,\, hd ,\, he \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{27.72} Cardinality (
 ProgramOrder ( h ) ) \.{=} CardOfProgramOrderOfHistory ( h )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} {\THEOREM} POPastTest
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land} POPast (
 ha ,\, R (\@w{x} ,\, 2 ,\, 2 ) )\@s{3.61} \.{=} \{ W (\@w{x} ,\, 1 ,\, 1 )
 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land} POPast (
 hb ,\, R (\@w{y} ,\, 1 ,\, 6 ) )\@s{4.26} \.{=} \{ W (\@w{x} ,\, 2 ,\, 4 )
 ,\, R (\@w{z} ,\, 0 ,\, 5 ) \}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\land} POPast (
 hc ,\, W (\@w{x} ,\, 2 ,\, 2 ) )\@s{0.18} \.{=} \{ \}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} CCvTest \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 {\lnot} CCv ( ha ) )}%
\@y{\@s{0}%
 4
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\land} CCv(hb) \.{\,\backslash\,}}* 7
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 {\lnot} CCv ( hc ) )\@s{0.71}}%
\@y{\@s{0}%
 4
}%
...
\@y{\@s{7.5}%
 \ensuremath{\.{\land} CCv(hd) \.{\,\backslash\,}}* 8
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 {\lnot} CCv ( he ) )\@s{0.52}}%
\@y{\@s{0}%
 6
}%
...
\@y{\@s{7.5}%
 \ensuremath{\.{\LET}} sat \ensuremath{\.{\defeq} \{hb,\, hd\}
}}%
\@xx{}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 13 09:07:14 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
