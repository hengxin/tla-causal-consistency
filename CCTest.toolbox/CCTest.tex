...
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} {\THEOREM} WellFormedTheorem
 \.{\defeq}}%
\@y{\@s{0}%
 test of well-formedness of histories
}%
\@xx{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} CardOfProgramOrderOfHistory
 ( h ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\LET}
 CardOfProgramOrderOfSession ( s ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{40.89} {\IF} Len ( s )
 \.{\leq} 1 \.{\THEN} 0 \.{\ELSE} Sum ( 1 \.{\dotdot} Len ( s ) \.{-} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 ReduceSet ( {\LAMBDA} s ,\, x \.{:} CardOfProgramOrderOfSession ( s ) \.{+}
 x ,\, h ,\, 0 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} {\THEOREM}
 ProgramOrderCardinalityTheorem \.{\defeq}}%
\@y{\@s{0}%
 test of \ensuremath{PO(h)
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \A\, h \.{\in} \{
 ha ,\, hb ,\, hc ,\, hd ,\, he \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{27.72} Cardinality ( PO (
 h ) ) \.{=} CardOfProgramOrderOfHistory ( h )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} {\THEOREM} POPastTest
 \.{\defeq}}%
\@y{\@s{0}%
 test of \ensuremath{POPast(h,\, o)
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{16.4} \.{\land} POPast (
 ha ,\, R (\@w{x} ,\, 2 ,\, 2 ) )\@s{3.61} \.{=} \{ W (\@w{x} ,\, 1 ,\, 1 )
 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \.{\land} POPast (
 hb ,\, R (\@w{y} ,\, 1 ,\, 6 ) )\@s{4.26} \.{=} \{ W (\@w{x} ,\, 2 ,\, 4 )
 ,\, R (\@w{z} ,\, 0 ,\, 5 ) \}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \.{\land} POPast (
 hc ,\, W (\@w{x} ,\, 2 ,\, 2 ) )\@s{0.18} \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\land} POPast (
 hd ,\, R (\@w{x} ,\, 1 ,\, 4 ) )\@s{3.35} \.{=} \{ W (\@w{x} ,\, 1 ,\, 1 )
 ,\, R (\@w{y} ,\, 0 ,\, 2 ) ,\, W (\@w{y} ,\, 1 ,\, 3 ) \}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \.{\land} POPast (
 he ,\, W (\@w{x} ,\, 2 ,\, 4 ) ) \.{=} \{ R (\@w{y} ,\, 1 ,\, 3 ) \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} {\THEOREM} CausalPastTest
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{TODO}: test of \ensuremath{CausalPast(co,\, o)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} {\FALSE}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} {\THEOREM} CausalHistTest
 \.{\defeq}\@s{1.39}}%
\@y{\@s{0}%
 \ensuremath{TODO}: test of \ensuremath{CausalHist(co,\, o)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} {\FALSE}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} {\THEOREM} CausalArbTest
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{TODO}: test of \ensuremath{CausalArb(co,\, ar,\, o)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} {\FALSE}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{AxCausalArb}, etc
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} {\THEOREM}
 RWRegSemanticsTest \.{\defeq}}%
\@y{\@s{0}%
 Test of \ensuremath{RWRegSemanticsTest(seq,\, o)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{16.4} \.{\land} {\lnot}
 RWRegSemantics ( {\langle} {\rangle} ,\, R (\@w{x} ,\, 2 ,\, 1 ) )}%
\@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{16.4}}%
\@y{\@s{0}%
 no \ensuremath{W(\@w{x},\, \_,\, \_)} in \ensuremath{seq
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{16.4} \.{\land}
 ...
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{16.4} \.{\land} {\lnot}
 RWRegSemantics ( {\langle} W (\@w{y} ,\, 1 ,\, 1 ) ,\, W (\@w{z} ,\, 1 ,\, 2
...
\@xx{}%
 ...
 (\@w{x} ,\, 2 ,\, 5 ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{16.4} \.{\land} {\lnot}
 RWRegSemantics ( {\langle} W (\@w{x} ,\, 1 ,\, 1 ) ,\, W (\@w{y} ,\, 1 ,\, 2
 ) ,\, W (\@w{x} ,\, 2 ,\, 3 ) ,\, W (\@w{z} ,\, 1 ,\, 4 ) {\rangle} ,\, R
 (\@w{x} ,\, 1 ,\, 5 ) )}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}} CCDefTest \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 CC ( ha ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 CC ( hc ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 {\lnot} CC ( he ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 sat \.{\defeq} \{ ha ,\, hb ,\, hc ,\, hd \}}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{27.51} \.{\IN} \.{\land}
 \A\, h \.{\in} sat \.{:} CC ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{47.91} \.{\land} \A\, h
 \.{\in} all \.{\,\backslash\,} sat \.{:} {\lnot} CC ( h )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}} CCvDefTest \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 {\lnot} CCv ( ha ) )}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 {\lnot} CCv ( hc ) )}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}} CCAlgTest \.{\defeq}}%
\@y{\@s{0}%
 Test of the checking algorithm for \ensuremath{CC} (Causal Consistency)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{16.4} \.{\LET} sat
 \.{\defeq} \{ ha ,\, hb ,\, hc ,\, hd \}}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 \A\, h \.{\in} sat \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{52.01} \.{\land} PrintT
 ( ToString ( h ) \.{\circ}\@w{\ is\ differentiated:\ } \.{\circ} ToString (
 IsDifferentiated ( h ) ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{52.01} \.{\land} CCAlg (
 h )}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{36.79} \.{\land} \A\, h
 \.{\in} all \.{\,\backslash\,} sat \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{52.01} \.{\land} PrintT
 ( ToString ( h ) \.{\circ}\@w{\ is\ differentiated:\ } \.{\circ} ToString (
 IsDifferentiated ( h ) ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{52.01} \.{\land} {\lnot}
 CCAlg ( h )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 20 14:11:35 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
