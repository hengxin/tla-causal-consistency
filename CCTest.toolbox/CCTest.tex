...
\@y{\@s{0}%
 no \ensuremath{W(\mbox{''}x\mbox{``},\, \_,\, \_)} in \ensuremath{seq
}}%
\@xx{}%
...
\@y{\@s{0}%
 contains \ensuremath{W(\mbox{''}x\mbox{``},\, \_,\, \_)} in \ensuremath{seq
}}%
\@xx{}%
...
\@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}} CCDefTest \.{\defeq}}%
 ...
 CC ( hc ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 {\lnot} CC ( he ) )}%
\@y{\@s{0}%
 too slow
}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 21 21:41:21 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
