...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} CC}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} TLC ,\, Sequences}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} Keys ,\,\@s{4.1}}%
\@y{\@s{0}%
 the set of keys
}%
\@xx{}%
\@x{\@s{51.42} Values\@s{3.05}}%
\@y{\@s{0}%
 the set of values
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ InitVal \.{\defeq} {\CHOOSE} v \.{:} v \.{\notin} Values}%
\@pvspace{8.0pt}%
 \@x{ Operation \.{\defeq} [ op \.{:} \{\@w{read} ,\,\@w{write} \} ,\, key
 \.{:} Keys ,\, val \.{:} Values ]}%
\@pvspace{8.0pt}%
 \@x{ R ( k ,\, v )\@s{4.14} \.{\defeq} [ op \.{\mapsto}\@w{read} ,\, key
 \.{\mapsto} k ,\, val \.{\mapsto} v ]}%
 \@x{ W ( k ,\, v ) \.{\defeq} [ op \.{\mapsto}\@w{write} ,\, key \.{\mapsto}
 k ,\, val \.{\mapsto} v ]}%
\@pvspace{8.0pt}%
\@x{ Session\@s{4.09} \.{\defeq} Seq ( Operation )}%
\@x{ History\@s{4.08} \.{\defeq} {\SUBSET} Session}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Ops ( h ) \.{\defeq}\@s{2.29}}%
\@y{\@s{0}%
 Get all operations of history \ensuremath{h \.{\in} History
}}%
\@xx{}%
\@x{\@s{8.2} {\FALSE}}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{\@s{8.2} \.{\land} \.{\LET} ops \.{\defeq} Ops ( h )}%
 \@x{\@s{19.31} \.{\IN} \.{\land} \E\, co \.{\in} {\SUBSET} ( ops \.{\times}
 ops ) \.{:}}%
\@x{\@s{59.02} \E\, arb \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
\@x{\@s{67.22} \A\, op \.{\in} ops \.{:} {\TRUE}}%
\@x{\@s{8.2} \.{\land} {\FALSE}}%
\@x{}\bottombar\@xx{}%
\end{document}
