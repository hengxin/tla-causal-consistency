...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\EXTENDS} TLC ,\, Sequences
 ,\, FiniteSets ,\, FunctionUtils}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} {\CONSTANTS} Keys ,\, Vals}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} InitVal \.{\defeq} {\CHOOSE}
 v \.{:} v \.{\notin} ( Keys \.{\cup} Vals )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} Operation \.{\defeq} [ op
 \.{:} \{\@w{read} ,\,\@w{write} \} ,\, key \.{:} Keys ,\, val \.{:} Vals ]}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} R ( k ,\, v )\@s{4.14}
 \.{\defeq} [ op \.{\mapsto}\@w{read} ,\, key \.{\mapsto} k ,\, val
 \.{\mapsto} v ]}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} W ( k ,\, v ) \.{\defeq} [
 op \.{\mapsto}\@w{write} ,\, key \.{\mapsto} k ,\, val \.{\mapsto} v ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} Session\@s{4.09} \.{\defeq}
 Seq ( Operation )\@s{2.77}}%
\@y{\@s{0}%
 A session \ensuremath{s \.{\in} Session} is a sequence of operations.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} History\@s{4.08} \.{\defeq}
 {\SUBSET} Session}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} hasa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ) ,\, R (\@w{x} ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} hasb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ) ,\, R (\@w{x} ,\, 1 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} ha \.{\defeq} \{ hasa ,\,
 hasb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} hbsa \.{\defeq} {\langle} W
 (\@w{z} ,\, 1 ) ,\, W (\@w{x} ,\, 1 ) ,\, W (\@w{y} ,\, 1 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} hbsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ) ,\, R (\@w{z} ,\, 0 ) ,\, R (\@w{y} ,\, 1 ) ,\,
 R (\@w{x} ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} hb \.{\defeq} \{ hbsa ,\,
 hbsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} hcsa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} hcsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ) ,\, R (\@w{x} ,\, 1 ) ,\, R (\@w{x} ,\, 2 )
 {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} hc \.{\defeq} \{ hcsa ,\,
 hcsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} hdsa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ) ,\, R (\@w{y} ,\, 0 ) ,\, W (\@w{y} ,\, 1 ) ,\, R (\@w{x}
 ,\, 1 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} hdsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ) ,\, R (\@w{y} ,\, 0 ) ,\, W (\@w{y} ,\, 2 ) ,\,
 R (\@w{x} ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} hd \.{\defeq} \{ hdsa ,\,
 hdsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} hesa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ) ,\, W (\@w{y} ,\, 1 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} hesb\@s{0.64} \.{\defeq}
 {\langle} R (\@w{y} ,\, 1 ) ,\, W (\@w{x} ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} hesc\@s{0.71} \.{\defeq}
 {\langle} R (\@w{x} ,\, 2 ) ,\, R (\@w{x} ,\, 1 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} he \.{\defeq} \{ hesa ,\,
 hesb ,\, hesc \}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} ProgramOrder ( h )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{8.2} \.{\LET}
 {\RECURSIVE} SessionProgramOrder ( \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{28.59}
 SessionProgramOrder ( s ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{36.79} {\IF} s \.{=}
 {\langle} {\rangle} \.{\THEN} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{36.79} \.{\ELSE} \.{\LET}
 sh\@s{2.49} \.{\defeq} Head ( s )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{92.61} st \.{\defeq} Tail
 ( s )}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{68.11} \.{\IN}\@s{4.09}
 \{ {\langle} sh ,\, t {\rangle} \.{:} t \.{\in} Range ( st ) \} \.{\cup}
 SessionProgramOrder ( st )}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{8.2} \.{\IN} {\UNION} \{
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{FIXME}: there may be multiple same operations in one and more
 sessions.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} Ops ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Return the set of all operations in history \ensuremath{h \.{\in} History}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{8.2} {\UNION} \{ Range (
 s ) \.{:} s \.{\in} h \}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}} CCv ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{8.2} \.{\land} \.{\LET}
 ops \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{19.31} \.{\IN} \.{\land}
 \E\, co \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{59.02} \E\, arb \.{\in}
 {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{67.22} \A\, op \.{\in}
 ops \.{:} {\TRUE}}%
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{8.2} \.{\land} {\FALSE}}%
\@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}}\bottombar\@xx{}%
\end{document}
