...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 (\ensuremath{POPL\.{'}}2017).
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\EXTENDS} TLC ,\, Naturals
 ,\, Sequences ,\, FiniteSets ,\, FiniteSetsExt ,\, FunctionUtils}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} hasa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) ,\, R (\@w{x} ,\, 2 ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} hasb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 3 ) ,\, R (\@w{x} ,\, 1 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} ha \.{\defeq} \{ hasa ,\,
 hasb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} hbsa \.{\defeq} {\langle} W
 (\@w{z} ,\, 1 ,\, 1 ) ,\, W (\@w{x} ,\, 1 ,\, 2 ) ,\, W (\@w{y} ,\, 1 ,\, 3
 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} hbsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 4 ) ,\, R (\@w{z} ,\, 0 ,\, 5 ) ,\, R (\@w{y}
 ,\, 1 ,\, 6 ) ,\, R (\@w{x} ,\, 2 ,\, 7 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} hb \.{\defeq} \{ hbsa ,\,
 hbsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} hcsa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} hcsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 2 ) ,\, R (\@w{x} ,\, 1 ,\, 3 ) ,\, R (\@w{x}
 ,\, 2 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} hc \.{\defeq} \{ hcsa ,\,
 hcsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} hdsa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) ,\, R (\@w{y} ,\, 0 ,\, 2 ) ,\, W (\@w{y} ,\, 1 ,\, 3
 ) ,\, R (\@w{x} ,\, 1 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} hdsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 5 ) ,\, R (\@w{y} ,\, 0 ,\, 6 ) ,\, W (\@w{y}
 ,\, 2 ,\, 7 ) ,\, R (\@w{x} ,\, 2 ,\, 8 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} hd \.{\defeq} \{ hdsa ,\,
 hdsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} hesa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) ,\, W (\@w{y} ,\, 1 ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} hesb\@s{0.64} \.{\defeq}
 {\langle} R (\@w{y} ,\, 1 ,\, 3 ) ,\, W (\@w{x} ,\, 2 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} hesc\@s{0.71} \.{\defeq}
 {\langle} R (\@w{x} ,\, 2 ,\, 5 ) ,\, R (\@w{x} ,\, 1 ,\, 6 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} he \.{\defeq} \{ hesa ,\,
 hesb ,\, hesc \}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}} ProgramOrder ( h )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{8.2} \.{\LET}
 {\RECURSIVE} SessionProgramOrder ( \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{28.59}
 SessionProgramOrder ( s ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{36.79} {\IF} s \.{=}
 {\langle} {\rangle} \.{\THEN} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{36.79} \.{\ELSE} \.{\LET}
 sh\@s{2.49} \.{\defeq} Head ( s )}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{92.61} st \.{\defeq} Tail
 ( s )}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{68.11} \.{\IN}\@s{4.09}
 \{ {\langle} sh ,\, t {\rangle} \.{:} t \.{\in} Range ( st ) \} \.{\cup}
 SessionProgramOrder ( st )}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{8.2} \.{\IN} {\UNION} \{
 SessionProgramOrder ( s ) \.{:} s \.{\in} h \}}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Test case: \ensuremath{TODO}: \ensuremath{Cardinality} testing
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}}%
\@y{%
 \ensuremath{CardOfProgramOrderOf(h) \.{\defeq}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}}%
\@y{%
 \ensuremath{{\THEOREM}} \ensuremath{CardOfProgramOrderTheorem \.{\defeq}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\A\, h \.{\in} \{ha,\, hb,\, hc,\, hd,\, he\}}:
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}}%
\@y{\@s{12.5}%
 \ensuremath{Cardinality(ProgramOrder(h)) \.{=} CardOfProgramOrderOf(h)
}}%
\@xx{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}} CCv ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{8.2} \.{\land} \.{\LET}
 ops \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{19.31} \.{\IN} \.{\land}
 \E\, co \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{59.02} \E\, arb \.{\in}
 {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{67.22} \A\, op \.{\in}
 ops \.{:} {\TRUE}}%
\@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{8.2} \.{\land} {\FALSE}}%
\@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}}\bottombar\@xx{}%
\end{document}
