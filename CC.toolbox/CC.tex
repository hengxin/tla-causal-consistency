...
\end{lcom}%
 ...
 Sequences ,\, Functions ,\, FiniteSets ,\, FiniteSetsExt ,\, RelationUtils
 ,\, TLC}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\CONSTANTS} Keys ,\, Vals}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} InitVal \.{\defeq} {\CHOOSE}
 v \.{:} v \.{\notin} ( Keys \.{\cup} Vals )}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} Operation \.{\defeq} [ op
 \.{:} \{\@w{read} ,\,\@w{write} \} ,\, key \.{:} Keys ,\, val \.{:} Vals ,\,
 oid \.{:} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} R ( k ,\, v ,\, oid
 )\@s{4.14} \.{\defeq} [ op \.{\mapsto}\@w{read} ,\, key \.{\mapsto} k ,\,
 val \.{\mapsto} v ,\, oid \.{\mapsto} oid ]}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} W ( k ,\, v ,\, oid )
 \.{\defeq} [ op \.{\mapsto}\@w{write} ,\, key \.{\mapsto} k ,\, val
 \.{\mapsto} v ,\, oid \.{\mapsto} oid ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Session\@s{0.01} \.{\defeq}
 Seq ( Operation )\@s{2.77}}%
\@y{\@s{0}%
 A session \ensuremath{s \.{\in} Session} is a sequence of operations.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} History \.{\defeq} {\SUBSET}
 Session}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} Ops ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Return the set of all operations in history \ensuremath{h \.{\in} History}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{8.2} {\UNION} \{ Range (
 s ) \.{:} s \.{\in} h \}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} WellFormed ( h ) \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}}%
\@y{\@s{2.5}%
 \ensuremath{\.{\land} h \.{\in} History
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{8.2} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} ProgramOrder ( h )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{8.2} \.{\LET}
 {\RECURSIVE} SessionProgramOrder ( \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{28.59}
 SessionProgramOrder ( s ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{36.79} {\IF} s \.{=}
 {\langle} {\rangle} \.{\THEN} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{36.79} \.{\ELSE} \.{\LET}
 sh\@s{2.49} \.{\defeq} Head ( s )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{92.61} st \.{\defeq} Tail
 ( s )}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{68.11} \.{\IN}\@s{4.09}
 \{ {\langle} sh ,\, t {\rangle} \.{:} t \.{\in} Range ( st ) \} \.{\cup}
 SessionProgramOrder ( st )}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{8.2} \.{\IN} {\UNION} \{
 SessionProgramOrder ( s ) \.{:} s \.{\in} h \}}%
...
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Specification of Causal Consistency: \ensuremath{CC}, \ensuremath{CCv}, and
 \ensuremath{CM
}%
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} CCv ( h ) \.{\defeq}}%
\@y{\@s{0}%
 Check whether \ensuremath{h \.{\in} History} satisfies \ensuremath{CCv}
 (Causal Convergence)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{8.2} \.{\land} WellFormed
 ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{8.2} \.{\land} \.{\LET}
 ops \.{\defeq} Ops ( h )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{19.31} \.{\IN} \.{\land}
 \E\, co \.{\in} {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{59.02} \E\, arb \.{\in}
 {\SUBSET} ( ops \.{\times} ops ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{67.22} \.{\land}
 IsStrictPartialOrder ( co ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{67.22} \.{\land}
 IsStrictTotalOrder ( arb ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{67.22} \.{\land} Respect
 ( co ,\, ProgramOrder ( h ) )}%
\@y{\@s{0}%
 \ensuremath{AxCausal
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{67.22} \.{\land} Respect
 ( arb ,\, co )\@s{62.15}}%
\@y{\@s{0}%
 \ensuremath{AxArb
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{67.22} \.{\land} \A\, op
 \.{\in} ops \.{:} {\TRUE}\@s{55.17}}%
\@y{\@s{0}%
 \ensuremath{TODO}: \ensuremath{AxCausalArb
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{8.2} \.{\land} {\FALSE}}%
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{TODO}: to automatically generate histories
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} hasa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) ,\, R (\@w{x} ,\, 2 ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} hasb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 3 ) ,\, R (\@w{x} ,\, 1 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} ha \.{\defeq} \{ hasa ,\,
 hasb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} hbsa \.{\defeq} {\langle} W
 (\@w{z} ,\, 1 ,\, 1 ) ,\, W (\@w{x} ,\, 1 ,\, 2 ) ,\, W (\@w{y} ,\, 1 ,\, 3
 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} hbsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 4 ) ,\, R (\@w{z} ,\, 0 ,\, 5 ) ,\, R (\@w{y}
 ,\, 1 ,\, 6 ) ,\, R (\@w{x} ,\, 2 ,\, 7 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} hb \.{\defeq} \{ hbsa ,\,
 hbsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}} hcsa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} hcsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 2 ) ,\, R (\@w{x} ,\, 1 ,\, 3 ) ,\, R (\@w{x}
 ,\, 2 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}} hc \.{\defeq} \{ hcsa ,\,
 hcsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}} hdsa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) ,\, R (\@w{y} ,\, 0 ,\, 2 ) ,\, W (\@w{y} ,\, 1 ,\, 3
 ) ,\, R (\@w{x} ,\, 1 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} hdsb\@s{0.64} \.{\defeq}
 {\langle} W (\@w{x} ,\, 2 ,\, 5 ) ,\, R (\@w{y} ,\, 0 ,\, 6 ) ,\, W (\@w{y}
 ,\, 2 ,\, 7 ) ,\, R (\@w{x} ,\, 2 ,\, 8 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}} hd \.{\defeq} \{ hdsa ,\,
 hdsb \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}} hesa \.{\defeq} {\langle} W
 (\@w{x} ,\, 1 ,\, 1 ) ,\, W (\@w{y} ,\, 1 ,\, 2 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}} hesb\@s{0.64} \.{\defeq}
 {\langle} R (\@w{y} ,\, 1 ,\, 3 ) ,\, W (\@w{x} ,\, 2 ,\, 4 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}} hesc\@s{0.71} \.{\defeq}
 {\langle} R (\@w{x} ,\, 2 ,\, 5 ) ,\, R (\@w{x} ,\, 1 ,\, 6 ) {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}} he \.{\defeq} \{ hesa ,\,
 hesb ,\, hesc \}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}} {\THEOREM} WellFormedTheorem
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{8.2} \A\, h \.{\in} \{
 ha ,\, hb ,\, hc ,\, hd ,\, he \} \.{:} WellFormed ( h )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}} CardOfProgramOrderOfHistory
 ( h ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{8.2} \.{\LET}
 CardOfProgramOrderOfSession ( s ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} {\IF} Len ( s )
 \.{\leq} 1 \.{\THEN} 0 \.{\ELSE} Sum ( 1 \.{\dotdot} Len ( s ) \.{-} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{8.2} \.{\IN}\@s{4.1}
 ReduceSet ( {\LAMBDA} s ,\, x \.{:} CardOfProgramOrderOfSession ( s ) \.{+}
 x ,\, h ,\, 0 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}} {\THEOREM}
 ProgramOrderCardinalityTheorem \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{8.2} \A\, h \.{\in} \{
 ha ,\, hb ,\, hc ,\, hd ,\, he \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{16.4} Cardinality (
 ProgramOrder ( h ) ) \.{=} CardOfProgramOrderOfHistory ( h )}%
\@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Apr} 03
 22:21:24 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
